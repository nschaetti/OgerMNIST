...
if __name__ == "__main__":
	...
	for angle in rc_Angle:
		...
		print "Paramètre rc_Angle valant {}".format(angle)
		...
		print '\033[93m' + "Paramètre rc_Angle valant {} : moyenne de {}".format(angle, np.average(results)) + '\033[0m'
