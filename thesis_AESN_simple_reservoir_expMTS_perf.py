...
rc_InputSparsity			= 0.05
rc_ReservoirSparsity		= 0.003
rc_Biais					= 1.0

rc_Size 					= 1200				# Taille du réservoir
...
if __name__ == "__main__":
	...
	print '\033[93m' + "Paramètre rc_SpectralRadius={},rc_LeakRate={} : moyenne de {}".format(rc_SpectralRadius, rc_LeakRate, np.average(results)) + '\033[0m'
