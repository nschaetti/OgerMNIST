...
if __name__ == "__main__":
	...
	for size in rc_Size:
		...
		for n in np.arange(0,rc_SampleSize):
			...
			joiner = JoinedStatesNode(image_size = digitImport.entrySize, input_dim = size)
		...
		print '\033[93m' + "Paramètre rc_SpectralRadius={},rc_LeakRate={},size={} : moyenne de {}".format(rc_SpectralRadius, rc_LeakRate, size, np.average(results)) + '\033[0m'
