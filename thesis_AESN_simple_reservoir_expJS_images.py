...
if __name__ == "__main__":
	...
	#print '\033[93m' + "Paramètre rc_SpectralRadius={},rc_LeakRate={} : moyenne de {}".format(rc_SpectralRadius, rc_LeakRate, der) + '\033[0m'
	digitImport.resetImages()
	for i in range(0,20):
		pos = miss_pos[i]
		digitImport.showImage(index = pos, sset = "test")
		print str(misses[pos,0]) + " but " + str(misses[pos,1])
