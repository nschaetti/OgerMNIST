...
if __name__ == "__main__":
	...
	# Série ondelettes
	digitImport.addTimeserieGaussian(start = rc_Start, end = rc_End, nbsteps = rc_NbSteps)
	...
	for n in np.arange(0,rc_SampleSize):
		...
		results[n] = der
		print "rc_SpectralRadius={},rc_LeakRate={} : moyenne de {}".format(rc_SpectralRadius,rc_LeakRate,der)
	print '\033[93m' + "rc_SpectralRadius={},rc_LeakRate={} : moyenne de {}".format(rc_SpectralRadius,rc_LeakRate,np.average(results)) + '\033[0m'
