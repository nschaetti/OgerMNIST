...
if __name__ == "__main__":
	...
	for size in rc_Size:
		...
		joiner = JoinedStatesNode(image_size = rc_NbSteps, input_dim = size)
		...
		print '\033[93m' + "rc_SpectralRadius={},rc_LeakRate={},rc_Size={} ::: {}".format(rc_SpectralRadius,rc_LeakRate,size,der) + '\033[0m'
