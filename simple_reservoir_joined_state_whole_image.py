...
if __name__ == "__main__":
	...
	if len(sys.argv) >= 5:
		rc_Size = int(sys.argv[4])
	
	# Resize
	digitImport.resizeImages(size = 22)
	
	# Série ondelettes
	digitImport.addTimeserieOndelette(start = 4, end = 22, nbsteps = 18)
	...
	joiner = JoinedStatesNode(image_size = 18, input_dim = rc_Size)
